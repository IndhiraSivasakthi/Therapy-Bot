...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetch("https://zenquotes.io/api/random")
      ...
      .catch(() => setQuote("Keep going, don&#39;t worry, you&rsquo;re doing great."));
      ...
      <main className="p-4">
        <div className="max-w-2xl mx-auto flex flex-col h-[90vh] border shadow-md rounded-lg overflow-hidden"
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {quote && (
              <div
                className="text-center italic text-sm mb-2 p-2 border rounded text-gray-500 dark:text-gray-400"
